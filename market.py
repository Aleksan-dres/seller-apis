...
def get_product_list(page, campaign_id, access_token): 
    ...
    (начальное значение должно быть пустым, если первый запрос). 
    campaign_id(str): Идентификатор продавца 
    access_token(str): Токен аутентификации компании(продавца) 
    
    Returns: 
    dict: Объект JSON где нас интересует значения 'result' и 'page_token'
...
def update_price(prices, campaign_id, access_token): 
    ...
    campaign_id(str): Идентификатор продавца для получения доступа к своему магазину на OZON
    access_token(str): Токен аутентификации компании(продавца) 
...
def get_offer_ids(campaign_id, market_token):
    ...
    Agrs: 
    campaign_id(str): Клиентский идентификатор для получения доступа к своему магазину на OZON
